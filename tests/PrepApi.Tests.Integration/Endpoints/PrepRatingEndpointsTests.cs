...
public class PrepRatingEndpointsTests(TestWebAppFactory factory) : IClassFixture<TestWebAppFactory>, IAsyncLifetime
{
    ...
    [Fact]
    public async Task CreatePrepRating_WithValidData_ReturnsCreated()
    {
        // Arrange
