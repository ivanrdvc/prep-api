...
public record UpdatePrepRequest
{
...
public class UpdatePrepRequestValidator : AbstractValidator<UpdatePrepRequest>
{
    public UpdatePrepRequestValidator()
    {
        ...
        RuleForEach(x => x.Steps).ChildRules(step => step.RuleFor(s => s.Description)
                .NotEmpty()
                .MaximumLength(1000));
